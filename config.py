...
# ===== ТОКЕНЫ =====
BOT_TOKEN = os.getenv("TELEGRAM_TOKEN")   # None если не задан — ок для VK бота
VK_TOKEN  = os.getenv("VK_TOKEN")         # None если не задан — ок для TG бота
